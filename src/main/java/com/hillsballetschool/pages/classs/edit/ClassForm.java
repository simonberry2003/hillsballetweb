...
import com.hillsballetschool.field.TimeConverter;
...
public class ClassForm extends AbstractStatelessForm<Classs> {
	...
	protected void addFields() {
		...
		add(new FieldText<Time>(Classs.Fields.START).setConverter(new TimeConverter()));
		add(new FieldText<Time>(Classs.Fields.END).setConverter(new TimeConverter()));
	}
